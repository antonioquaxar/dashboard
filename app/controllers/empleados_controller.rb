class EmpleadosController < ApplicationController
  ...
  private
    ...
    def empleado_params
      params.require(:empleado).permit(:nombre, :apellidoPaterno, :apellidoMaterno, :fechaNacimiento, :telefono, :email, :nss, :categoria, :activo, :fechaCreacion, :fehcaActualizacion)
    end
end
